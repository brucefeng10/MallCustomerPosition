...
def main():
    ...
    for key,val in tsd.predict_examples.items():    # 对每一个mall训练一个模型以及预测值
        ...
        knn = neighbors.KNeighborsClassifier(n_neighbors=10, weights='distance', algorithm='kd_tree')
    ...
    f = open(r"C:\Users\Feng\Desktop\CustomerPosition\results\KNNresult_20171115.csv",
